...
public class KuaipanHTTPUtility {
    ...
    public static KuaipanHTTPResponse doUpload(KuaipanURL baseurl,
            InputStream datastream, long size, ProgressListener lr)
            throws KuaipanIOException {
    ...
    public static KuaipanHTTPResponse doDownload(KuaipanURL baseurl,
            OutputStream os, ProgressListener lr) throws KuaipanIOException {
        KuaipanHTTPResponse resp = new KuaipanHTTPResponse();
    ...
    private static HttpURLConnection getConnectionFromUrl(String baseurl,
            String method) throws KuaipanIOException {
        URL url = null;
    ...
    private static void multipartUploadData(HttpURLConnection con,
            InputStream datastream, long size, ProgressListener lr)
            throws KuaipanIOException {
     ...
     * @throws KuaipanIOException
     */
    private static void bufferedWriting(OutputStream to_write,
            InputStream to_read, long total, ProgressListener lr)
            throws KuaipanIOException {
